...
from tensorflow.keras.layers import Input, Dense, Dropout, Embedding, LSTM, add # type: ignore
...
word_to_index = None
with open("A:\study\PROJECTS\AD 2\project\Image-Captioning\Helper\word_to_index.pkl", 'rb') as f:
  word_to_index = pickle.load(f)

index_to_word = None
with open("A:\study\PROJECTS\AD 2\project\Image-Captioning\Helper\index_to_word.pkl", 'rb') as f:
  index_to_word = pickle.load(f)

model = load_model("A:\study\PROJECTS\AD 2\project\Image-Captioning\Model Weights\model_weights_50.h5")
